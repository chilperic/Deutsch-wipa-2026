...
function setAudience(a){USER.audience=a;document.body.classList.toggle('admin',a==='admin');document.body.classList.toggle('student',a!=='admin');save();renderMenu()}
...
(async function init(){applyTheme(); setAudience(USER.audience); await loadVocabFiles(); await loadPrepVerbFile(); save(); renderMenu();})();